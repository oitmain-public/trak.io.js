...
define('exceptions/revenue_property_invalid',['exception'], function(Exception) {
...
define('exceptions/trial_expired',['exception'], function(Exception) {
  var TrialExpired;
  return TrialExpired = (function(_super) {
    __extends(TrialExpired, _super);

    function TrialExpired() {
      return TrialExpired.__super__.constructor.apply(this, arguments);
    }
...
;(function(window) {
  ...
  function runInContext(context) {
    ...
    lodash.getIndexOf = getIndexOf;
    lodash.contains = contains;
    lodash.filter = filter;
    lodash.find = find;
    lodash.cloneDeep = cloneDeep;
    lodash.baseClone = baseClone;
...
// Generated by IcedCoffeeScript 1.7.1-b
define('jsonp',['exceptions', 'json2', 'lodash'], function(Exceptions, JSON, _) {
  var JSONP;
