...
describe('trakio/automagic/identify', function() {
  _;
  ...
  return describe('#event_fired', function() {
    ...
    context("when form matches any value for has_any_fields", function() {
    ...
    context("when form doesn't match any values for has_any_fields", function() {
      value(automagic_options).equals(function() {
        return {
          identify: {
            has_any_fields: ['my_field', 'another_field'],
    ...
    context("when form matches all values for has_all_fields", function() {
      value(automagic_options).equals(function() {
        return {
          identify: {
            has_any_fields: ['my_field', 'another_field'],
    ...
    context("when form doesn't match all values for has_all_fields", function() {
      value(automagic_options).equals(function() {
        return {
          identify: {
            has_any_fields: ['my_field', 'another_field'],
    ...
    context("when form doesn't provied a distinct_id", function() {
      value(form).equals_haml("%form.a_form\n  %input{ name: \"user[name]\", value: \"name_value\" }");
      afterEach(function() {
        return trak.io.distinct_id.restore();
      });
    ...
    context("when form matches the identify form selector", function() {
      value(automagic_options).equals(function() {
        return {
          identify: {
            selector: '.a_form'
    ...
    return context("when a form does not match the identify form selector", function() {
      value(automagic_options).equals(function() {
        return {
          identify: {
            selector: '.my_form'
